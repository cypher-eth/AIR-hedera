...
contract WaterContractTest is Test {
    ...
    function testWaterContractCalculation() public {
        // Test with 0.04 HBAR
        uint256 hbarAmount = 0.04 ether; // 0.04 HBAR in wei
        console.log("=== WATER Contract Test ===");
    ...
    function testSmallAmount() public {
        // Test with a very small amount to see if there's precision loss
        uint256 hbarAmount = 0.0001 ether; // 0.0001 HBAR in wei
